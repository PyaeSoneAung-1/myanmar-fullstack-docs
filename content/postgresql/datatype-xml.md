...
`xml` data type က XML data တွေကို သိမ်းဆည်းဖို့ သုံးနိုင်ပါတယ်။ `text` field တစ်ခုထဲမှာ XML data သိမ်းတာထက် အားသာချက်က — input values တွေကို well-formed (ဖွဲ့စည်းပုံ စည်းမျဉ်းနဲ့ ကိုက်ညီ) မှု ရှိမရှိ စစ်ဆေးပေးပြီး — type-safe (type ပိုင်း လုံခြုံသော) လုပ်ဆောင်ချက်တွေ လုပ်ပေးနိုင်တဲ့ support functions တွေ ပါရှိတာပဲ ဖြစ်ပါတယ်; [အပိုင်း 9.15](/docs/postgresql/functions-xml) ကို ကြည့်ပါ။ ဒီ data type ကို သုံးနိုင်ဖို့ဆိုရင် — installation ကို `configure --with-libxml` နဲ့ build လုပ်ထားဖို့ လိုအပ်ပါတယ်။
